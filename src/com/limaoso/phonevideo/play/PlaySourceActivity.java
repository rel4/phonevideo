...
import com.limaoso.phonevideo.play.utils.SDUtils;
...
public class PlaySourceActivity extends BaseActivity implements
	...
	protected void initTVHead() {
		...
		mHelp.showImage(mIv_play_source_page_show, TextUtils
				.isEmpty(cfilmlist.picdown) ? cfilmlist.pic : cfilmlist.picdown); // 设置相对应条目的电影预览图
	...
	private void dowmItemPositionVideo(final int position) {
		...
		// 内存不足
		if (cfilmlist.filesize > (SDUtils.getCacheAvailableSize() - 1024 * 1024 * 200)) {
