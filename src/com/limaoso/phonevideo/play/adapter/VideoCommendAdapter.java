 ...
 * 推荐视频的样式设置
 */
public abstract class VideoCommendAdapter extends
		RecyclerView.Adapter<VideoCommendAdapter.ViewHolder> implements
		OnClickListener {
	/** 推荐影片数据的集合 */
	...
	public void onBindViewHolder(ViewHolder viewHolder, int position) {
		mHttpHelp.showImage(viewHolder.iv_video_commend_iocn,
				mList.get(position).hpic);
