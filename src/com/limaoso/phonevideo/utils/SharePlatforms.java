...
public class SharePlatforms {
	...
	public SharePlatforms(Activity activity, UMSocialService mController,
			com.limaoso.phonevideo.play.bean.PlayBaen.Cont.Shareinfo shareinfo) {
	...
	private void addCustomPlatforms() {
		...
		mController.getConfig().setPlatforms(SHARE_MEDIA.WEIXIN,
				...
				SHARE_MEDIA.SINA, SHARE_MEDIA.FACEBOOK, SHARE_MEDIA.LAIWANG,
	...
	private void addPinterest() {
		 ...
		 */
		UMPinterestHandler pinterestHandler = new UMPinterestHandler(activity,
				"1439206");
	...
	private void addWXPlatform() {
		...
		String appId = "wxb797ac821655b5b2";
		String appSecret = "d7aaf8b4b4792a5f35d13bff0cb487ff";
		// 添加微信平台
	...
	private void addInstagram() {
		...
		UMImage localImage = new UMImage(activity, R.drawable.already_step_down);
