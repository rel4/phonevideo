...
public class UpdateManager implements android.view.View.OnClickListener {
				...
				VersionInfo.class, new MyRequestCallBack<VersionInfo>() {
					...
					public void onSucceed(VersionInfo bean) {
						...
						if (isUpdate(vcodeInt)) {
							PrefUtils.setString(GlobalConstant.UPLOAD_DESC,
									bean.cont.desc);
							PrefUtils.setString(GlobalConstant.UPLOAD_VNAME,
									bean.cont.vname);
							PrefUtils.setString(GlobalConstant.UPLOAD_FSIZE,
									bean.cont.fsize);
							PrefUtils.setString(GlobalConstant.UPLOAD_PDATE,
									bean.cont.pdate);
							downloadApk(bean);
				...
				new LoadRequestCallBack() {
					...
					public void onSucceed(ResponseInfo t) {
						...
						if (bean != null && bean.cont != null
							...
							PrefUtils.setInt(mContext,
									GlobalConstant.UPLOADVERSIONCODE, code);
						}
						// 显示提示对话框
	...
	private void showNotifi() {
		...
		notification = new Notification(R.drawable.ic_launcher, appName,
