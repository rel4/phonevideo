...
public class TVplayActivity extends BaseActivity implements
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.rb_home_title_all_featured: // 精选
			childPageAddContent(ShowPage.TV, ShowPage.FEATURED, FEATURED_TV,
					false); // 给精彩页面添加内容
			break;
		case R.id.rb_home_title_all_china: // 大陆
			childPageAddContent(ShowPage.TV, ShowPage.DALU, DALU_TV, false); // 给大陆页面添加内容
			break;
		case R.id.rb_home_title_all_tvb: // tvb
			childPageAddContent(ShowPage.TV, ShowPage.GANGTAI, GANGTAI_TV,
					false); // 给港台页面添加内容
			break;
		case R.id.rb_home_title_all_jandk: // 日韩
			childPageAddContent(ShowPage.TV, ShowPage.RIHAN, RIHAN_TV, false); // 给日韩页面添加内容
			break;
		case R.id.rb_home_title_all_america: // 美剧
			childPageAddContent(ShowPage.TV, ShowPage.OUMEI, OUMEI_TV, false); // 给欧美页面添加内容
			break;
		case R.id.rb_home_title_all_more: // 更多
			childPageAddContent(ShowPage.TV, ShowPage.MORE, null, true); // 给更多页面添加内容
