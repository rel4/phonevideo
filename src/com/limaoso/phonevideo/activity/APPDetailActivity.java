...
import com.limaoso.phonevideo.bean.FindDetailBean;
...
import com.limaoso.phonevideo.view.HorizontalListView;
...
public class APPDetailActivity extends BaseActivity implements OnClickListener {
	...
	protected void initView() {
		...
		if (getId.getStringExtra(GlobalConstant.DL_APP_ID) != null) {
			DetailId = getId.getStringExtra(GlobalConstant.DL_APP_ID);
		...
		sv_adetail = (ScrollView) findViewById(R.id.sv_adetail);
	...
	private void initData() {
		...
		ratingBar.setRating(CheckUtils.isNumber(FDbean.cont.stars) ? Float
