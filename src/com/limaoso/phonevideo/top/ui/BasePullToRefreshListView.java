package com.limaoso.phonevideo.top.ui;
...
public class BasePullToRefreshListView extends PullToRefreshListView {
	...
	private void init() {
		// this.demo();
		ILoadingLayout startLabels = this.getLoadingLayoutProxy(true, false);
		startLabels.setPullLabel("下拉刷新...");// 刚下拉时，显示的提示
		startLabels.setRefreshingLabel("正在载入...");// 刷新时
		startLabels.setReleaseLabel("放开刷新...");// 下来达到一定距离时，显示的提示
		// startLabels.setTextTypeface(tf)
		ILoadingLayout endLabels = this.getLoadingLayoutProxy(false, true);
