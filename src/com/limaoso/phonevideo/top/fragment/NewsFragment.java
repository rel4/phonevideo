...
import com.limaoso.phonevideo.activity.menu.WebViewActivity;
import com.limaoso.phonevideo.global.GlobalConstant;
import com.limaoso.phonevideo.play.PlayActivity;
import com.limaoso.phonevideo.top.adapter.ListBaseAdapter;
import com.limaoso.phonevideo.top.bean.BaseTopBean;
import com.limaoso.phonevideo.top.bean.DTVListBaen.DTvCont;
import com.limaoso.phonevideo.top.manager.ThreadManager;
import com.limaoso.phonevideo.top.protocol.NewsFragmentProtocol;
import com.limaoso.phonevideo.top.ui.BasePullToRefreshListView;
import com.limaoso.phonevideo.top.ui.LoadingPage.LoadResult;
				...
				if (isPullDownToRefresh) {
					for (int i = loaddatas.size() - 1; i >= 0; i--) {
						...
						if (dTvCont != null && !maps.containsKey(dTvCont.id)) {
							...
							boolean isrRemove = datas.remove(maps
									.get(dTvCont.id));
							maps.put(dTvCont.id, dTvCont);
