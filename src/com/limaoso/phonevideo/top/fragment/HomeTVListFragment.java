package com.limaoso.phonevideo.top.fragment;
...
import com.limaoso.phonevideo.top.ChannelActivity;
...
import com.limaoso.phonevideo.view.ColumnHorizontalScrollView;
import com.limaoso.phonevideo.widget.ViewPager;
import com.limaoso.phonevideo.widget.ViewPager.OnPageChangeListener;
...
public class HomeTVListFragment extends Fragment {
	...
	public HomeTVListFragment(TopActivity topActivity) {
	...
	private void initView() {
		...
		button_more_columns.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// topActivity.startActivityForResult(intent, CHANNELREQUEST);
				topActivity.startActivityForResult(intent, GlobalConstant.ZERO);
			}
		});
	...
	private void initTabColumn() {
		...
		for (int i = 0; i < count; i++) {
			...
			Drawable drawable = getResources().getDrawable(
					R.drawable.dr_title_text_bottom_line_selector);
