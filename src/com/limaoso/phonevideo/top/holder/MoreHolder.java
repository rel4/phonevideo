...
import com.limaoso.phonevideo.top.adapter.DefaultAdapter;
...
public class MoreHolder extends BaseHolder<Integer> {
	...
	protected View initView() {
		...
		loading_error_txt = (TextView) contentView
				.findViewById(R.id.loading_error_txt);
		return contentView;
	}
	...
	public void refreshView(Integer data) {
		if (data == HAS_MORE) {
			...
			if (loading_error_txt != null) {
				loading_error_txt.setText(UIUtils.getContext().getString(
						R.string.load_error));
			}
