...
import com.limaoso.phonevideo.top.manager.HttpHelper;
...
public abstract class BaseProtocol<T> {
	...
	private String loadFromLocal(int channelid, int page) {
		...
		File file = new File(dirPath, getKey() + getParams() + "_" + channelid
				+ "_" + page);
		if (file.exists()) {
	...
	private String loadServer(int channelid, int page) {
		String json = HttpHelper.sendGet(NetworkConfig.getDTVListAll(channelid,
				page));
		return json;
	}
